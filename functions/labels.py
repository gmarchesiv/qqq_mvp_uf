...
def generar_garch(params, varsLb,app):
    ...
    varsLb.retorno_lista.append(app.etfs[10]["symbol"])
 
    varsLb.retorno=app.etfs[10]["symbol"] / varsLb.retorno_lista[0] -1
...
def generar_hour_back(params, varsLb,app):
    varsLb.ret_1H_back.append(app.etfs[10]["symbol"])
    varsLb.ret_3H_back.append(app.etfs[10]["symbol"])
    varsLb.ret_6H_back.append(app.etfs[10]["symbol"])
    varsLb.ret_12H_back.append(app.etfs[10]["symbol"])
    varsLb.ret_24H_back.append(app.etfs[10]["symbol"])
    varsLb.ret_96H_back.append(app.etfs[10]["symbol"])
    pass

def generar_rsi(params, varsLb,app):
    varsLb.etf_price_lista.append(app.etfs[10]["symbol"])
...
def generar_d_pico(params, varsLb,app):
    if app.etfs[10]["symbol"] > varsLb.pico_etf:
        varsLb.pico_etf=app.etfs[10]["symbol"]

    varsLb.d_pico=app.etfs[10]["symbol"]/varsLb.pico_etf -1
...
def clusterizar(params, varsLb,app):
    ...
    df=pd.DataFrame(
        ...
        {
            "VIX_CLOSE":[app.etfs[11]["symbol"]],
            "QQQ_GARCH":[varsLb.garch],
            "ret_1H_back":[(app.etfs[10]["symbol"]/ varsLb.ret_1H_back[0] -1)*100],
            "ret_3H_back":[(app.etfs[10]["symbol"]/ varsLb.ret_3H_back[0] -1)*100],
            "ret_6H_back":[(app.etfs[10]["symbol"]/ varsLb.ret_6H_back[0] -1)*100],
            "ret_12H_back":[(app.etfs[10]["symbol"]/ varsLb.ret_12H_back[0] -1)*100],
            "ret_24H_back":[(app.etfs[10]["symbol"]/ varsLb.ret_24H_back[0] -1)*100],
            "ret_96H_back":[(app.etfs[10]["symbol"]/ varsLb.ret_96H_back[0] -1)*100],
