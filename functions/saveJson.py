...
def saveJson(vars, app, params, estado):
    ...
    datos = {
        ...
        "askbid_call_prom": vars.askbid_put_prom.astype(float).tolist(),
        "askbid_put_prom":  vars.askbid_put_prom.astype(float).tolist(),
        ...
        "label": vars.label,
        "retorno_lista": vars.retorno_lista.astype(float).tolist(),
        "retorno": vars.retorno,
        "signo": vars.signo,
        "varianza": vars.varianza,
        "pico_etf": vars.pico_etf,
        "d_pico": vars.d_pico,
        "ret_1H_back": vars.ret_1H_back.astype(float).tolist(),
        "ret_3H_back": vars.ret_3H_back.astype(float).tolist(),
        "ret_6H_back": vars.ret_6H_back.astype(float).tolist(),
        "ret_12H_back": vars.ret_12H_back.astype(float).tolist(), 
        "ret_24H_back": vars.ret_24H_back.astype(float).tolist(),
        "ret_96H_back": vars.ret_96H_back.astype(float).tolist(),
        "etf_price_lista": vars.etf_price_lista.astype(float).tolist(),
        "rsi": vars.rsi,
